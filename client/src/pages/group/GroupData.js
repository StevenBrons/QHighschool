		...
		return (
			<div style={{ position: "relative" }}>
				...
				<div style={{ display: "flex" }} className="ColumnFlexDirectionOnMobile">
					...
					<div style={{ width: "100%" }}>
						<Field value={group.courseDescription} maxLength={500} name="courseDescription" label="Omschrijving" labelVisible onChange={onChange} area editable={editable} default="Dit aanbod heeft geen omschrijving." rowsMax={10} fullWidth />

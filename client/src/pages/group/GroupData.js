				...
				<div style={{ display: "flex" }} className="ColumnFlexDirectionOnMobile">
					<div style={{ display: "flex", flexDirection: "column" }}>
						<div style={{ flex: 1 }}>
							...
							<Field value={group.day} name="day" editable={editable && role === "admin"} onChange={onChange} caption style={{ width: "100px" }} options={["maandag", "dinsdag", "woensdag", "donderdag", "vrijdag", "zaterdag", "zondag"]} />
